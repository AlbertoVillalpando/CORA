Característica: Subir archivos a una conferencia
    ...
    Escenario: Subida exitosa de archivo ZIP
        ...
        Y selecciono la conferencia "Conferencia Innovación 2024 - Edición" presionando el boton Subir
        Y subo el archivo .zip 
        Cuando presiono el botón Subir
        Entonces el sistema muestra el boton "Archivo" en la conferencia "Conferencia Innovación 2024 - Edición"
