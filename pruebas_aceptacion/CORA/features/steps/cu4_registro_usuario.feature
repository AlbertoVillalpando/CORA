...
Y ingreso mi nombre "jose emmanuel", apellido "sandoval sanchez", correo "usuario4@example.com" y una contraseña "ContrasenaSegura123"
...
Dado que ingreso a la plataforma en la URL "http://localhost:8000/usuarios/registro/"
Y ingreso mi nombre "jose emmanuel", apellido "sandoval sanchez", correo "autorP@autorP.com" y una contraseña "ContrasenaSegura123"
Y confirmo la contraseña "ContrasenaSegura123"
Y selecciono el área de conocimiento "Medicina"
Cuando presiono el botón "Registrarse"
Entonces debo ver un mensaje de error "Este correo ya está registrado"


Escenario: Registro fallido por usuario ya registrado
Dado que ingreso a la plataforma en la URL "http://localhost:8000/usuarios/registro/"
Y ingreso mi nombre "jose emmanuel", apellido "sandoval sanchez", correo "usuario4@example.com" y una contraseña "ContrasenaSegura123"
Y confirmo la contraseña "ContrasenaSegura123"
Y selecciono el área de conocimiento "Medicina"
