...
def step_impl(context):
    ...
    context.driver.find_element(
        By.NAME, 'username').send_keys("autorP@autorP.com")
...
def step_impl(context):
    context.driver.maximize_window()
    context.driver.find_element(By.NAME, 'username').send_keys(
...
def step_impl(context):
    context.driver.maximize_window()
    context.driver.find_element(
        By.NAME, 'username').send_keys("revisorP@revisorP.com")
    context.driver.find_element(By.NAME, 'password').send_keys("P123456789")
    sleep(2)
    context.driver.find_element(By.CLASS_NAME, 'btn-primary').click()
    sleep(2)
...
def step_impl(context):
    context.driver.maximize_window()
    context.driver.find_element(
        By.NAME, 'username').send_keys("adminP@adminP.com")
    context.driver.find_element(By.NAME, 'password').send_keys("P123456789")
    sleep(2)
    context.driver.find_element(By.CLASS_NAME, 'btn-primary').click()
    sleep(2)
